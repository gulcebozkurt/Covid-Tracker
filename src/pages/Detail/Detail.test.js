...
// projede thunk kullandığımız için onuda tanıtıyoruz
const mockStore = configureStore([thunk]);

it("yüklenme durumunda loader bileşenleri ekrana basılır", () => {
    // loading durumunda storedaki veriyi simüle etme
    ...
    // loader'lar ekrana geliyor mu kontrol etme
